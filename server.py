...
def loadCompetitions():
    """Load competitions's data from json"""
...
def purchasePlaces():
    ...
    if competition and club:
        ...
        if total_reserved > MAX_PLACES:
            flash(
                "You cannot book more than 12 places in total for a competition."
            )
            return redirect(
                url_for(
